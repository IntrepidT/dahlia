...
const BUTTON_SECONDARY: &str = "px-4 py-2 bg-gray-200 rounded-md font-medium text-gray-500 hover:text-gray-900 hover:border-gray-700 transition-colors border border-gray-300";
